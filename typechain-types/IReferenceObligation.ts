...
export interface IReferenceObligationInterface extends utils.Interface {
  contractName: "IReferenceObligation";
  functions: {
    "checkIsDefaulted(uint8)": FunctionFragment;
    "checkIsExpired()": FunctionFragment;
    "getMaxLoss(uint8)": FunctionFragment;
    "loanIdCounter()": FunctionFragment;
...
export interface IReferenceObligation extends BaseContract {
  contractName: "IReferenceObligation";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReferenceObligationInterface;
  ...
  loanIdCounter(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    loanIdCounter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
