...
export interface PremiumPayoutsInterface extends utils.Interface {
  contractName: "PremiumPayouts";
  functions: {
...
export interface PremiumPayouts extends BaseContract {
  contractName: "PremiumPayouts";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PremiumPayoutsInterface;
